...
import nz.co.android.riverwatch.event.GetIncidentsEvent;
...
import nz.co.android.riverwatch.fragments.PreviewFragment;
import nz.co.android.riverwatch.service.GetIncidentsAsyncTask;
...
public class PreviewActivity extends AbstractSubmissionActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		handler = new Handler();
		con = this;
		System.out.println("setup_start");
		setupUI();
