...
import nz.co.android.riverwatch.utility.JSONHelper;
...
//			public static final String FORM_POST_AFTERIMAGE = "after-image";
			...
			File file = new File(imagePath.substring(7));
			if(file.exists()){
...
//		"chroma": {"nitrite":{"hue":1, "sat":2, "bri":3}, "nitrate":{"hue":4, "sat":5, "bri":6}}
		...
		jsonObjectNitrite.put(Constants.SUBMISSION_JSON_HUE, nitriteColor.h);
		jsonObjectNitrite.put(Constants.SUBMISSION_JSON_SAT, nitriteColor.s);
		jsonObjectNitrite.put(Constants.SUBMISSION_JSON_BRI, nitriteColor.b);

		jsonObjectNitrate.put(Constants.SUBMISSION_JSON_HUE, nitrateColor.h);
		jsonObjectNitrate.put(Constants.SUBMISSION_JSON_SAT, nitrateColor.s);
		jsonObjectNitrate.put(Constants.SUBMISSION_JSON_BRI, nitrateColor.b);
...
//		"analysis":{"nitrate-level":13, "nitrite-level":15}
		...
		jsonObjectAnalysis.put(Constants.SUBMISSION_JSON_NITRATE_LEVEL, nitrate);
		jsonObjectAnalysis.put(Constants.SUBMISSION_JSON_NITRITE_LEVEL, nitrite);
